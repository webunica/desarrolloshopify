        ...
        <>
            <nav className="fixed top-0 w-full z-50 glass-panel border-b border-border">
                <div className="container mx-auto px-6 h-16 flex items-center justify-between">
                    {/* Logo */}
                    <Link href="/" className="text-xl font-bold tracking-tighter text-foreground hover:opacity-80 transition-opacity z-50 flex items-center gap-2">
                    ...
                    {/* Desktop Menu */}
                    <div className="hidden md:flex gap-6 lg:gap-8 text-sm font-medium text-muted-foreground">
                        {navLinks.map((link) => (
                            <Link
                                key={link.href}
                                href={link.href}
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Button
                            ...
                            variant="default"
                            size="sm"
                            className="hidden md:flex shadow-lg font-bold transition-all duration-300 hover:scale-105"
                        >
